 ...
 <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <div class="row">
    <div class="col-lg-3">
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
          <img src="http://localhost/BVP/admin/logo1.png" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="col-lg-9 mt-5 mb-5">
        <form action="/admin/update-donation.php?id=<?php $id ?>" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="name" class="form-label">Charity Name</label>
                <input type="text" name="name" class="form-control" id="name" value="<?php echo $row["charity_name"] ?>" aria-describedby="emailHelp" required>

              </div>
            <div class="mb-3">
              <label for="country" class="form-label">Charity Country</label>
              <input type="text" name="country" class="form-control" value="<?php echo $row["charity_country"] ?>" id="country" aria-describedby="emailHelp" required>

            </div>
            <div class="mb-3">
              <label for="amount" class="form-label">Amount of Donation</label>
              <input type="number" class="form-control" value="<?php echo $row["amount"] ?>" name="amount" id="amount" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo $row["links"] ?>" name="link" id="link" required>
            </div>
